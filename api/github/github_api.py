...
class GitHubAPIHandler(BaseAPIHandler):
    ...
    def _live_impl(self, username_param, repo_param, limit_param) -> dict:
    ...
    def get_recent_commits(self, username: str = None, repo: str = None, limit: int = 10) -> dict:
        ...
        """
        result = self.call("commits", self.hash(username, repo, limit), lambda: self._live_impl(username, repo, limit), stale_ok=True)
