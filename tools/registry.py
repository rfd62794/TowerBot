...
from .search.search_tools import web_search, news_search, wiki_lookup, reddit_search, get_weather, fetch_url, get_weather_forecast, get_pypi_stats, get_recent_commits, useless_fact, number_fact, random_quote, wiki_random, spacex_latest_launch, jina_read
...
TOOL_REGISTRY = {
    ...
    "jina_read": {
        ...
        "definition": {
            ...
            "function": {
                "name": "jina_read",
                "description": "Read a URL and return clean markdown content via Jina Reader. No authentication required.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "url": {
