...
def test_message_roundtrip():
    from infra.db import create_thread, add_message, get_context
...
def test_memory_roundtrip():
    from infra.db import save_memory, list_memories
...
def test_tool_cache_miss():
    from infra.db import get_cached_tool_result
...
def test_channel_history_roundtrip():
    from infra.db import record_channel_day, get_channel_history
...
def test_queue_roundtrip():
    from infra.db import queue_observation, get_pending_observations, mark_sent
...
def test_thread_roundtrip():
    from infra.db import create_thread, update_thread_name, list_threads
...
def test_goal_roundtrip():
    from infra.db import upsert_goal, get_goal
